...
public class PowerProjectCircuitInfoOutput {
    ...
    public String powerOptimize(String fileStringFormat) throws Exception {
        ...
        for (Map<String, String> edge : edges) {
            ...
            Map<String, Object> objectMap = projectCircuitInfoOutput.circuitInfoByEdge(id, loopdetails,
                    (String) edge.get("分支名称"));
        ...
        for (String s : bundleIdList) {
            ...
            for (Map<String, String> stringStringMap : edges) {
                if (s.equals(stringStringMap.get("分支id编号"))) {
                    ...
                    String startPoint = projectCircuitInfoOutput.getWaterParam(startPointName,
                            (List<Map<String, String>>) projectInfo.get("所有端点信息"));
                    String endPoint = projectCircuitInfoOutput.getWaterParam(endPointNameString,
                            (List<Map<String, String>>) projectInfo.get("所有端点信息"));
            ...
            Map<String, String> colorMap = projectCircuitInfoOutput.getColorByEdges(list, circuitInfo, wet.equals("W"),
        ...
        // Map<String, Map<String, String>> connectedEdgesByMatrix =
        // projectCircuitInfoOutput.findConnectedEdgesByMatrix(points,
        // bundeleRelatedCircuitInfo, adjacencyMatrixGraph, edges);
