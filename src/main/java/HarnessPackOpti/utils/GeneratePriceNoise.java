 ...
 * 回路单价扰动
 */
public class GeneratePriceNoise {
    Random random = new Random();

    public void generatePriceNoise(List<String> normList, List<List<String>> changeList, List<Map<String, Object>> edges,
        ...
        //对成本价格表拷贝一份，方便后续恢复
        Map<String, Map<String, String>> elecFixedLocationLibraryCopy = elecFixedLocationLibrary.entrySet()
                .stream()
...
//                e.printStackTrace();
        ...
        //价格恢复
        ProjectCircuitInfoOutput.elecFixedLocationLibrary = elecFixedLocationLibraryCopy;
    }

    double perturbLength(double originalLength) {
