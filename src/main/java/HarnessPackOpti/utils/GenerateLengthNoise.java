 ...
 * 扰动分支长度样本生成
 */
public class GenerateLengthNoise {
    public static Random random = new Random();

    public void generateLengthNoise(List<String> normList, List<List<String>> changeList,
            List<Map<String, Object>> edges,
            Map<String, Object> jsonMap, Map<String, Map<String, String>> elecFixedLocationLibrary,
            List<String> edgeChooseBS, String filePath, List<Map<String, Object>> collectedSamples) throws Exception {
        ...
        // 分支长度集合
        List<Float> branchLengthList = getBranchLength(edgeFirst);
        ...
        for (Future<Map<String, Object>> future : futures) {
            try {
                ...
                if (result != null) {
                    TypeCheckUtils.countType("length");
    ...
    public static List<Float> getBranchLength(List<Map<String, Object>> edges) {
        ...
        for (Map<String, Object> edge : edges) {
            ...
            double v = perturbLength(length);
            branchLengthList.add(Float.parseFloat(df.format(v)));
        }
        return branchLengthList;
    }

    public static double perturbLength(double originalLength) {
        // [0.75, 1.25] 均匀分布，每个值概率相同
