...
import HarnessPackOpti.ErrorOutput.PowerDistributionDriveErrorOuput;
import HarnessPackOpti.ErrorOutput.PowerTopoOptimizeErrorOutput;
...
//                 powerDistributionDriveOptimization.powerDriverOptimize(jsonContent);
        ...
        // breakRecognize.recognizeBreak(adjacencyMatrixGraph.getAdj()
        ...
        // String(Files.readAllBytes(file.toPath()));//将文件中内容转为字符串
        //
        // ProjectCircuitInfoOutput projectCircuitInfoOutput=new
...
//        circuitErrorOutput.powerDistributionDriveErrorOuput(jsonContent1);
        ...
        // String(Files.readAllBytes(file2.toPath()));//将文件中内容转为字符串
        //
        // ElecLocationErrorOutput elecLocationErrorOutput = new
        // ElecLocationErrorOutput();
        // elecLocationErrorOutput.electionErrorOutput(jsonContent2);
        //
        //
        // ElecFixedLocationOutput elecFixedLocationOutput = new
        // ElecFixedLocationOutput();
        ...
        // HarnessBranchTopoOptimize harnessBranchTopoOptimize=new
        // HarnessBranchTopoOptimize();
        // File file = new File("data/DataCoopWithEB/elec/1206.txt");
        // String jsonContent = new
        // String(Files.readAllBytes(file.toPath()));//将文件中内容转为字符串
        // ElecPositionVariantCalculationTest elecPositionVariantCalculation = new
        // ElecPositionVariantCalculationTest();
        // ElecPositionVariantOutput elecPositionVariantOutput=new
        // ElecPositionVariantOutput();
